...
void AABStageGimmick::OnGateTriggerBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	DrawDebugBox(GetWorld(), NewLocation, FVector(800.0f, 800.0f, 800.0f), FColor::Red, false, 5.0f);
#endif
...
void AABStageGimmick::SpawnRewardBoxes()
{
	for (auto RewardBoxLocation : RewardBoxLocations)
	{
		...
		RewardBoxActor->GetTrigger()->OnComponentBeginOverlap.AddDynamic(this, &AABStageGimmick::OnRewardBoxTriggerBeginOverlap);
